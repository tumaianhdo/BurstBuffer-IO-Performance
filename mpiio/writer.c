...
extern int mpi_write(int rank, const char *filename, int dims, int* npdim, uint64_t* spdim, size_t elem_size, MPI_Comm gcomm);
...
int main (int argc, char **argv) {
	...
	mpi_write(rank, filename, dims, np, sp, elem_size, gcomm);
